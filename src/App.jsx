...
function SearchMoviesList({ movies }) {
  return (
    <ul className="list">
      {movies?.map((movie) => (
        <SearchMoviesItem key={movie.imdbID} movie={movie} />
      ))}
    </ul>
  );
}

function SearchMoviesItem({ movie }) {
  return (
    <li>
...
function WatchMoviesList({ watched }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <WatchMoviesItem movie={movie} key={movie.imdbID} />
      ))}
    </ul>
  );
}

function WatchMoviesItem({ movie }) {
  return (
    <>
      <li>
        <img src={movie.Poster} alt={`${movie.Title} poster`} />
